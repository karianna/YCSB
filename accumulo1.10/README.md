...
See the [Accumulo Documentation](https://accumulo.apache.org/1.10/accumulo_user_manual.html#_installation)
...
[Accumulo Documentation](https://accumulo.apache.org/1.10/accumulo_user_manual.html#_basic_administration)
...
Load the data:
    ...
    ./bin/ycsb load accumulo1.10 -s -P workloads/workloada \
...
Run the workload test:
    ...
    ./bin/ycsb run accumulo1.10 -s -P workloads/workloada  \
         -p accumulo.zooKeepers=localhost \
         -p accumulo.columnFamily=ycsb \
         -p accumulo.instanceName=ycsb \
         -p accumulo.username=user \
...
- `accumulo.zooKeepers`
  - The Accumulo cluster's [zookeeper servers](https://accumulo.apache.org/1.10/accumulo_user_manual.html#_connecting).
  - Should contain a comma separated list of hostname or hostname:port values.
  - No default value.
...
- `accumulo.instanceName`
  - Name of the Accumulo [instance](https://accumulo.apache.org/1.10/accumulo_user_manual.html#_connecting).
  - No default value.
